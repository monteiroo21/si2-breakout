...
def train(args) -> None:
    ...
    print(f"[{args.tag}] VANILLA DQN  device={device}  steps={args.timesteps}")
...
def add_common_args(parser: argparse.ArgumentParser) -> None:
    parser.add_argument("--tag", default="scratch_vanilla", help="output folder under models/ and runs/")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Vanilla DQN from scratch")
    ...
    if args.eval_only:
        ...
        print_eval("vanilla", args.model, args.episodes, peaks, clears, survivals)
        return
